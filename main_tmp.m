...
% 
% r=find(d>0); %class 1
% r1=setdiff(1:length(A(:,1)),r); %class -1
% Y1=d(r,:);
% Y2=d(r1,:);
% DataTrain.A=A(r,:); %positive class samples
% DataTrain.B=A(r1,:); %negative class samples
% 
%           FunPara.c1=0.1;
%           FunPara.c2=0.1;
%           FunPara.c3=0.1;
...
% 
% [predY,w1,w2] = TWSVM_tmp(A,DataTrain,FunPara);
%     i1=find(w1>0);
%     j1=find(w2>0);
%     k1=union(i1,j1);
%     A=A(:,k1);
%     deriv1=deriv1(:,k1);  %1st derivative
%     deriv2=deriv2(:,k1);  %2nd derivative
...
for i = 1:k
    ...
    [predY,w1,w2] = TWSVM_tmp(Ctrain,DataTrain,FunPara);
    i1=find(w1>0);
    j1=find(w2>0);
    k1=union(i1,j1);
    Ctrain=Ctrain(:,k1);
    Ctrain_deriv1=Ctrain_deriv1(:,k1);
    Ctrain_deriv2=Ctrain_deriv2(:,k1);
    Ctest=Ctest(:,k1);
    Ctest_deriv1=Ctest_deriv1(:,k1);
    Ctest_deriv2=Ctest_deriv2(:,k1);
    cc=cc(:,k1);
    dd=dd(:,k1);
    cc1=cc1(:,k1);
    dd1=dd1(:,k1);
